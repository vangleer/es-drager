...
function Ce(r, n, e) {
  ...
  return be(() => {
    ...
    console.log(o, f, "width, height"), h.value = { ...h.value, width: o || 100, height: f || 100 }, r.value.addEventListener("mousedown", l), r.value.addEventListener("touchstart", l);
  }), K(a, (o) => {
...
const Ve = ["data-side", "onMousedown", "onTouchstart"], Ge = /* @__PURE__ */ R("div", { class: "es-drager-dot-handle" }, null, -1), Pe = /* @__PURE__ */ R("div", { class: "es-drager-mask" }, null, -1), ie = /* @__PURE__ */ ae({
  ...
  setup(r, { emit: n }) {
    ...
    return K(() => [
      ...
      ref: v,
      class: Ee(["es-drager", { disabled: c.disabled, dragging: b(d), selected: b(h), border: c.border }]),
      style: te(b(g)),
      onClick: s[3] || (s[3] = ne(() => {
      }, ["stop"]))
    }, {
      default: oe(() => [
        ...
        !c.disabled && b(h) ? (z(), ee(Ie, {
          key: 1,
          modelValue: b(l).angle,
          "onUpdate:modelValue": s[0] || (s[0] = (i) => b(l).angle = i),
          "drag-data": b(l),
          element: a.value,
          onRotate: s[1] || (s[1] = (i) => t("rotate", b(l))),
          onRotateStart: s[2] || (s[2] = (i) => t("rotate-start", b(l))),
          onRotateEnd: o
        }, {
          default: oe(() => [
            C(c.$slots, "rotate")
